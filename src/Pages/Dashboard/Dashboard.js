    ...
    return (
        <div>
            <header className='flex-row pad-1rem5'>
                ...
                <div className={styles.userDetails}><p className='nomargin bold font-size-med'>Naresh Naik</p><p className='nomargin text-muted'>Business magnate and Investor</p></div>
            </header>
            <main className='flex-col pad-1rem5'>
                ...
                <div className='d-flex w-100 mt-4 flex-wrap'>
                    <div className='p-3 w-50'><Image className='img-fluid' src={goalsImg}/></div>
                    <div className='p-3 w-50'><Image className='img-fluid' src={learningsImg}/></div>
                    <div className='p-3 w-50'><Image className='img-fluid' src={buyImg} onClick={() => props.navigateTo(Pages.BUY)}/></div>
                    <div className='p-3 w-50'><Image className='img-fluid' src={problemsImg}/></div>
                    <div className='p-3 w-50'><Image className='img-fluid' src={journalImg} onClick={() => props.navigateTo(Pages.JOURNAL)}/></div>
                </div>
            </main>
        </div>
    )
